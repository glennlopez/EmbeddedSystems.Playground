...
Texas Instrument Family
=================
Everything I do with TI's chipset will be stored here. Make sure to check out the [Wiki](https://github.com/glennlopez/EmbeddedSystems.Playground/wiki) for information on how to configure these devices.
...
* [GUI Composer](http://processors.wiki.ti.com/index.php/CCS_Modules_Library#GUI_Composer)