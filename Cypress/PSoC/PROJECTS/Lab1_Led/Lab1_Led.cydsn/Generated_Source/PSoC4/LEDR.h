...
#define LEDR_DM_ALG_HIZ         (0x00u << LEDR_DRIVE_MODE_SHIFT)
#define LEDR_DM_DIG_HIZ         (0x01u << LEDR_DRIVE_MODE_SHIFT)
#define LEDR_DM_RES_UP          (0x02u << LEDR_DRIVE_MODE_SHIFT)
#define LEDR_DM_RES_DWN         (0x03u << LEDR_DRIVE_MODE_SHIFT)
#define LEDR_DM_OD_LO           (0x04u << LEDR_DRIVE_MODE_SHIFT)
#define LEDR_DM_OD_HI           (0x05u << LEDR_DRIVE_MODE_SHIFT)
#define LEDR_DM_STRONG          (0x06u << LEDR_DRIVE_MODE_SHIFT)
#define LEDR_DM_RES_UPDWN       (0x07u << LEDR_DRIVE_MODE_SHIFT)
