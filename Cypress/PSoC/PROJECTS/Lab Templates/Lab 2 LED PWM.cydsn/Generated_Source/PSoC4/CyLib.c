...
*   0        CY_SYS_CLK_SYSCLK_DIV1        SYSCLK = HFCLK / 1
*   1        CY_SYS_CLK_SYSCLK_DIV2        SYSCLK = HFCLK / 2
*   2        CY_SYS_CLK_SYSCLK_DIV4        SYSCLK = HFCLK / 4
*   3        CY_SYS_CLK_SYSCLK_DIV8        SYSCLK = HFCLK / 8
*   4        CY_SYS_CLK_SYSCLK_DIV16       SYSCLK = HFCLK / 16
*   5        CY_SYS_CLK_SYSCLK_DIV32       SYSCLK = HFCLK / 32
*   6        CY_SYS_CLK_SYSCLK_DIV64       SYSCLK = HFCLK / 64
*   7        CY_SYS_CLK_SYSCLK_DIV128      SYSCLK = HFCLK / 128
*
* Return:
*  None
*
...
*      1<<0    CY_SYS_WDT_COUNTER0_MASK      0
*      1<<8    CY_SYS_WDT_COUNTER1_MASK      1
*      1<<16   CY_SYS_WDT_COUNTER2_MASK      2
*
* Return:
*  None
*
...
void CySoftwareReset(void)
{
    ...
    ***************************************************************************/
    CY_SYS_CM0_AIRCR_REG = (CY_SYS_CM0_AIRCR_REG & ~CY_SYS_CM0_AIRCR_VECTKEY_MASK) |
