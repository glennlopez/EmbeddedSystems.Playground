...
static void UART_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    ...
    /* Note: the DR register settings do not effect the pin output if HSIOM is other than GPIO */
        ...
        UART_spi_mosi_i2c_sda_uart_rx_SetDriveMode((uint8) pinsDm[UART_MOSI_SCL_RX_PIN_INDEX]);

    #if (!UART_CY_SCBIP_V1)
        UART_SET_INP_DIS(UART_spi_mosi_i2c_sda_uart_rx_INP_DIS,
                                     UART_spi_mosi_i2c_sda_uart_rx_MASK,
        ...
        UART_spi_mosi_i2c_sda_uart_rx_wake_SetDriveMode((uint8)
                                                               pinsDm[UART_MOSI_SCL_RX_WAKE_PIN_INDEX]);

        UART_SET_INP_DIS(UART_spi_mosi_i2c_sda_uart_rx_wake_INP_DIS,
                                     UART_spi_mosi_i2c_sda_uart_rx_wake_MASK,
        ...
        UART_spi_miso_i2c_scl_uart_tx_SetDriveMode((uint8) pinsDm[UART_MISO_SDA_TX_PIN_INDEX]);

    #if (!UART_CY_SCBIP_V1)
        UART_SET_INP_DIS(UART_spi_miso_i2c_scl_uart_tx_INP_DIS,
                                     UART_spi_miso_i2c_scl_uart_tx_MASK,
        ...
        UART_spi_sclk_uart_cts_SetDriveMode((uint8) pinsDm[UART_SCLK_PIN_INDEX]);

        UART_SET_INP_DIS(UART_spi_sclk_uart_cts_INP_DIS,
                                     UART_spi_sclk_uart_cts_MASK,
        ...
        UART_spi_ss0_uart_rts_SetDriveMode((uint8) pinsDm[UART_SS0_PIN_INDEX]);

        UART_SET_INP_DIS(UART_spi_ss0_uart_rts_INP_DIS,
                                     UART_spi_ss0_uart_rts_MASK,
