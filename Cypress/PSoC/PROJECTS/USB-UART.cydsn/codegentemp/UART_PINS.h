...
****************************************/
    ...
    #include "UART_spi_mosi_i2c_sda_uart_rx_wake.h"
#endif /* (UART_MOSI_SCL_RX_WAKE_PIN) */

#if(UART_MOSI_SCL_RX_PIN)
    #include "UART_spi_mosi_i2c_sda_uart_rx.h"
#endif /* (UART_MOSI_SCL_RX_PIN) */

#if(UART_MISO_SDA_TX_PIN)
    #include "UART_spi_miso_i2c_scl_uart_tx.h"
#endif /* (UART_MISO_SDA_TX_PIN_PIN) */

#if(UART_SCLK_PIN)
    #include "UART_spi_sclk_uart_cts.h"
#endif /* (UART_SCLK_PIN) */

#if(UART_SS0_PIN)
    #include "UART_spi_ss0_uart_rts.h"
#endif /* (UART_SS1_PIN) */
...
***************************************/
    ...
    #define UART_MOSI_SCL_RX_WAKE_HSIOM_REG  \
                                                (*(reg32 *) UART_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM)
    #define UART_MOSI_SCL_RX_WAKE_HSIOM_PTR  \
                                                ( (reg32 *) UART_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM)
    #define UART_MOSI_SCL_RX_WAKE_HSIOM_MASK \
                                                (UART_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM_MASK)
    #define UART_MOSI_SCL_RX_WAKE_HSIOM_POS  \
                                                (UART_spi_mosi_i2c_sda_uart_rx_wake__0__HSIOM_SHIFT)

    #define UART_MOSI_SCL_RX_WAKE_INTCFG_REG    (*(reg32 *) \
                                                              UART_spi_mosi_i2c_sda_uart_rx_wake__0__INTCFG)
    #define UART_MOSI_SCL_RX_WAKE_INTCFG_PTR    ( (reg32 *) \
                                                              UART_spi_mosi_i2c_sda_uart_rx_wake__0__INTCFG)

    #define UART_INTCFG_TYPE_MASK                  (0x03u)
    #define UART_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS  (UART_spi_mosi_i2c_sda_uart_rx_wake__SHIFT)
...
#if(UART_MOSI_SCL_RX_PIN)
    #define UART_MOSI_SCL_RX_HSIOM_REG      (*(reg32 *) UART_spi_mosi_i2c_sda_uart_rx__0__HSIOM)
    #define UART_MOSI_SCL_RX_HSIOM_PTR      ( (reg32 *) UART_spi_mosi_i2c_sda_uart_rx__0__HSIOM)
    #define UART_MOSI_SCL_RX_HSIOM_MASK     (UART_spi_mosi_i2c_sda_uart_rx__0__HSIOM_MASK)
    #define UART_MOSI_SCL_RX_HSIOM_POS      (UART_spi_mosi_i2c_sda_uart_rx__0__HSIOM_SHIFT)
#endif /* (UART_MOSI_SCL_RX_PIN) */

#if(UART_MISO_SDA_TX_PIN)
    #define UART_MISO_SDA_TX_HSIOM_REG      (*(reg32 *) UART_spi_miso_i2c_scl_uart_tx__0__HSIOM)
    #define UART_MISO_SDA_TX_HSIOM_PTR      ( (reg32 *) UART_spi_miso_i2c_scl_uart_tx__0__HSIOM)
    #define UART_MISO_SDA_TX_HSIOM_MASK     (UART_spi_miso_i2c_scl_uart_tx__0__HSIOM_MASK)
    #define UART_MISO_SDA_TX_HSIOM_POS      (UART_spi_miso_i2c_scl_uart_tx__0__HSIOM_SHIFT)
#endif /* (UART_MISO_SDA_TX_PIN_PIN) */

#if(UART_SCLK_PIN)
    #define UART_SCLK_HSIOM_REG     (*(reg32 *) UART_spi_sclk_uart_cts__0__HSIOM)
    #define UART_SCLK_HSIOM_PTR     ( (reg32 *) UART_spi_sclk_uart_cts__0__HSIOM)
    #define UART_SCLK_HSIOM_MASK    (UART_spi_sclk_uart_cts__0__HSIOM_MASK)
    #define UART_SCLK_HSIOM_POS     (UART_spi_sclk_uart_cts__0__HSIOM_SHIFT)
#endif /* (UART_SCLK_PIN) */

#if(UART_SS0_PIN)
    #define UART_SS0_HSIOM_REG      (*(reg32 *) UART_spi_ss0_uart_rts__0__HSIOM)
    #define UART_SS0_HSIOM_PTR      ( (reg32 *) UART_spi_ss0_uart_rts__0__HSIOM)
    #define UART_SS0_HSIOM_MASK     (UART_spi_ss0_uart_rts__0__HSIOM_MASK)
    #define UART_SS0_HSIOM_POS      (UART_spi_ss0_uart_rts__0__HSIOM_SHIFT)
#endif /* (UART_SS1_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define UART_SET_I2C_SCL_DR(val) \
                            UART_spi_mosi_i2c_sda_uart_rx_Write(val)
    ...
    #define UART_WAIT_SCL_SET_HIGH  (0u == UART_spi_mosi_i2c_sda_uart_rx_Read())
...
/* Unconfigured SCB: sda signal */
    ...
    #define UART_WAIT_SDA_SET_HIGH  (0u == UART_spi_miso_i2c_scl_uart_tx_Read())
