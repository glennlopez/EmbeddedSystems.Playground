// ======================================================================
// Lab3_PWM.v generated from TopDesign.cysch
// 01/01/2015 at 03:21
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0\cy_constant_v1_0.v"
`endif
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_tff_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_tff_v1_0\cy_tff_v1_0.v"
`endif
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0\not_v1_0.v"
`endif

// PWM_v3_10(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_COMPONENT_NAME=PWM_v3_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM2, CY_INSTANCE_SHORT_NAME=PWM2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1, INSTANCE_NAME=PWM2, )
module PWM_v3_10_1 (
    pwm2,
    tc,
    clock,
...
module top ;
	...
	cy_clock_v1_0
		#(.id("fa75a95e-ca9c-4b10-8279-531330d57da5"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__LEDR_net;
	wire [0:0] tmpFB_0__LEDR_net;
	wire [0:0] tmpIO_0__LEDR_net;
	wire [0:0] tmpINTERRUPT_0__LEDR_net;
	electrical [0:0] tmpSIOVREF__LEDR_net;
	...
	cy_psoc3_pins_v1_10
		...
		LEDR
		 (.oe(tmpOE__LEDR_net),
		  .y({Net_54}),
		  .fb({tmpFB_0__LEDR_net[0:0]}),
		  .io({tmpIO_0__LEDR_net[0:0]}),
		  .siovref(tmpSIOVREF__LEDR_net),
		  .interrupt({tmpINTERRUPT_0__LEDR_net[0:0]}),
		  .annotation({Net_166}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LEDR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_54 = Net_83 | Net_52;

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_82)
    begin
        cy_tff_1 <= Net_81^Net_83;
    end
    assign Net_83 = cy_tff_1;
    // -- TFF End --

    assign Net_81 = 1'h1;

	wire [0:0] tmpOE__LEDB_net;
	wire [0:0] tmpFB_0__LEDB_net;
	wire [0:0] tmpIO_0__LEDB_net;
	wire [0:0] tmpINTERRUPT_0__LEDB_net;
	electrical [0:0] tmpSIOVREF__LEDB_net;
	...
	cy_psoc3_pins_v1_10
		...
		LEDB
		 (.oe(tmpOE__LEDB_net),
		  .y({Net_104}),
		  .fb({tmpFB_0__LEDB_net[0:0]}),
		  .io({tmpIO_0__LEDB_net[0:0]}),
		  .siovref(tmpSIOVREF__LEDB_net),
		  .interrupt({tmpINTERRUPT_0__LEDB_net[0:0]}),
		  .annotation({Net_340}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LEDB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_100 = ~Net_83;


    assign Net_104 = Net_324 | Net_100;
	...
	cy_clock_v1_0
		#(.id("61d31f90-a2c0-48ed-a0a3-3f71ddd75c3f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1666666666666.67"),
		  .is_direct(0),
		  .is_digital(0))
		clk2
		 (.clock_out(Net_131));
