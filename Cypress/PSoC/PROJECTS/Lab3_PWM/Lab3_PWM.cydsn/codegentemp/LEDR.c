...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        LEDR_PC =   (LEDR_PC & \
                                (uint32)(~(uint32)(LEDR_DRIVE_MODE_IND_MASK << (LEDR_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (LEDR_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  LEDR_DM_STRONG     Strong Drive 
*  LEDR_DM_OD_HI      Open Drain, Drives High 
*  LEDR_DM_OD_LO      Open Drain, Drives Low 
*  LEDR_DM_RES_UP     Resistive Pull Up 
*  LEDR_DM_RES_DWN    Resistive Pull Down 
*  LEDR_DM_RES_UPDWN  Resistive Pull Up/Down 
*  LEDR_DM_DIG_HIZ    High Impedance Digital 
*  LEDR_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(LEDR__0__SHIFT, mode);
}
...
*  
* Note:
*  Macro LEDR_ReadPS calls this function. 
*  
*******************************************************************************/
