...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Pin_2_PC =   (Pin_2_PC & \
                                (uint32)(~(uint32)(Pin_2_DRIVE_MODE_IND_MASK << (Pin_2_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Pin_2_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(Pin_2__0__SHIFT, mode);
}
