...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Pin_6_PC =   (Pin_6_PC & \
                                (uint32)(~(uint32)(Pin_6_DRIVE_MODE_IND_MASK << (Pin_6_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Pin_6_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(Pin_6__0__SHIFT, mode);
}
