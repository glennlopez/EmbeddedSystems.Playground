...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Pin_4_PC =   (Pin_4_PC & \
                                (uint32)(~(uint32)(Pin_4_DRIVE_MODE_IND_MASK << (Pin_4_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Pin_4_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(Pin_4__0__SHIFT, mode);
}
