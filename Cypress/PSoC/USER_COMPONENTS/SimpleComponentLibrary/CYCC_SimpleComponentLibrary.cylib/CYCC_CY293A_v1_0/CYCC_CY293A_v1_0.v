...
// Generated on 02/24/2013 at 12:24
// Component: CYCC_CY293A_v1_0
module CYCC_CY293A_v1_0 (
	output wire  CO,       // Carry output
	output wire[7:0] Q,    // Accumulator output
	input  wire  CI,       // Carry input
	input  wire  clk,      // Clock 
	input  wire [7:0] D,   // Data input
	input  wire LnA,       // Load (active low) or accumulate input
	input  wire  MR        // Master reset input
);
...
.cy_dpconfig(
{
    ...
    `CS_SHFT_OP_PASS, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE,
    `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA,
    `CS_CMP_SEL_CFGA, /*CFGRAM1: Accumulate  (A0 = A0  + pi + ci)*/
    `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0,
