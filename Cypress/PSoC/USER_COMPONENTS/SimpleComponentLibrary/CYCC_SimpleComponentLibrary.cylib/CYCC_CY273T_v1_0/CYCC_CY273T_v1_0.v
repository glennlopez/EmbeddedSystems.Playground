...
// ========================================
// Simple CY273T Octal Tff demostration to show users a
...
// Generated on 02/03/2013 at 16:27
// Component: CYCC_CY273T_v1_0
module CYCC_CY273T_v1_0 (
	output [7:0] Q,     // Flip-Flop Outputs
	input   clk,        // Clock Input
	input   MRn,        // Asynchronous Master Reset Input (Active Low)
	input  [7:0] T      // Flip-Flip Inputs
);

//`#start body` -- edit after this line, do not edit this line
    wire   reset;
	assign reset = ~MRn;          //invert reset
...
cy_psoc3_dp #(.cy_dpconfig(
{
    ...
    `CS_CMP_SEL_CFGA, /*CFGRAM0: load  po = A0 = A0  XOR pi*/
    ...
    `SC_WRK16CAT_DSBL /*CFG17-16:  */
        ...
        /*  input                   */  .reset(reset),    // Connet reset to datapath
        /*  input                   */  .clk(clk),        // Connet clock to dtapath
        ...
        /* output [07:00]           */  .po(Q[7:0])    // Connect datapath to paralle output
);
//`#end` -- edit above this line, do not edit this line
endmodule
