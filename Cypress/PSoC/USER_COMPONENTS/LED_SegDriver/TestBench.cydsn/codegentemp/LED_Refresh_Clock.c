...
/*******************************************************************************
* Function Name: LED_Refresh_Clock_Start
********************************************************************************
* Summary:
...
void LED_Refresh_Clock_Start(void) 
{
    ...
    LED_Refresh_Clock_CLKEN |= LED_Refresh_Clock_CLKEN_MASK;
}


/*******************************************************************************
* Function Name: LED_Refresh_Clock_Stop
********************************************************************************
* Summary:
...
void LED_Refresh_Clock_Stop(void) 
{
	...
	CYDEV_CHIP_REVISION_USED == CYDEV_CHIP_REVISION_5A_ES1))
/*******************************************************************************
* Function Name: LED_Refresh_Clock_StopBlock
********************************************************************************
* Summary:
...
{
    if (LED_Refresh_Clock_CLKEN & LED_Refresh_Clock_CLKEN_MASK)
    {
        ...
        CLK_DIST_AMASK = LED_Refresh_Clock_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = LED_Refresh_Clock_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(LED_Refresh_Clock_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(LED_Refresh_Clock_DIV_PTR, oldDivider);
#endif
    }
}
#endif
...
/*******************************************************************************
* Function Name: LED_Refresh_Clock_StandbyPower
********************************************************************************
* Summary:
...
void LED_Refresh_Clock_StandbyPower(uint8 state) 
{
    if(state == 0)
    {
        LED_Refresh_Clock_CLKSTBY &= ~LED_Refresh_Clock_CLKSTBY_MASK;
    }
    else
    {
        LED_Refresh_Clock_CLKSTBY |= LED_Refresh_Clock_CLKSTBY_MASK;
...
/*******************************************************************************
* Function Name: LED_Refresh_Clock_SetDividerRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void LED_Refresh_Clock_SetDividerRegister(uint16 clkDivider, uint8 restart) 
{
    uint8 enabled;

    uint8 currSrc = LED_Refresh_Clock_GetSourceRegister();
    uint16 oldDivider = LED_Refresh_Clock_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = LED_Refresh_Clock_CLKEN & LED_Refresh_Clock_CLKEN_MASK;
        ...
        if (currSrc == CYCLK_SRC_SEL_CLK_SYNC_D && (oldDivider == 0 || clkDivider == 0))
        {
            ...
            if (oldDivider == 0 && clkDivider != 0)
            {
                ...
                CY_SET_REG16(LED_Refresh_Clock_DIV_PTR, clkDivider);
                LED_Refresh_Clock_MOD_SRC &= ~CYCLK_SSS;
            }
            else
            {
        ...
        else
        {
            ...
            LED_Refresh_Clock_CLKEN |= enabled;
        }
    }
}
...
/*******************************************************************************
* Function Name: LED_Refresh_Clock_GetDividerRegister
********************************************************************************
* Summary:
...
{
    return CY_GET_REG16(LED_Refresh_Clock_DIV_PTR);
}


/*******************************************************************************
* Function Name: LED_Refresh_Clock_SetModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void LED_Refresh_Clock_SetModeRegister(uint8 clkMode) 
{
    LED_Refresh_Clock_MOD_SRC |= clkMode & LED_Refresh_Clock_MODE_MASK;
}


/*******************************************************************************
* Function Name: LED_Refresh_Clock_ClearModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void LED_Refresh_Clock_ClearModeRegister(uint8 clkMode) 
{
    LED_Refresh_Clock_MOD_SRC &= ~clkMode | ~LED_Refresh_Clock_MODE_MASK;
}
...
/*******************************************************************************
* Function Name: LED_Refresh_Clock_GetModeRegister
********************************************************************************
* Summary:
...
{
    return LED_Refresh_Clock_MOD_SRC & LED_Refresh_Clock_MODE_MASK;
}


/*******************************************************************************
* Function Name: LED_Refresh_Clock_SetSourceRegister
********************************************************************************
* Summary:
...
{
    uint16 currDiv = LED_Refresh_Clock_GetDividerRegister();
    uint8 oldSrc = LED_Refresh_Clock_GetSourceRegister();
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        LED_Refresh_Clock_MOD_SRC |= CYCLK_SSS;
        LED_Refresh_Clock_MOD_SRC =
            (LED_Refresh_Clock_MOD_SRC & ~LED_Refresh_Clock_SRC_SEL_MSK) | clkSource;
    }
...
/*******************************************************************************
* Function Name: LED_Refresh_Clock_GetSourceRegister
********************************************************************************
* Summary:
...
{
    return LED_Refresh_Clock_MOD_SRC & LED_Refresh_Clock_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: LED_Refresh_Clock_SetPhaseRegister
********************************************************************************
* Summary:
...
{
    LED_Refresh_Clock_PHASE = clkPhase & LED_Refresh_Clock_PHASE_MASK;
}


/*******************************************************************************
* Function Name: LED_Refresh_Clock_GetPhase
********************************************************************************
* Summary:
...
{
    return LED_Refresh_Clock_PHASE & LED_Refresh_Clock_PHASE_MASK;
}
