...
{
    if (LED_PWM_Clock_CLKEN & LED_PWM_Clock_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void LED_PWM_Clock_SetModeRegister(uint8 clkMode) 
{
    LED_PWM_Clock_MOD_SRC |= clkMode & LED_PWM_Clock_MODE_MASK;
}
...
*
*******************************************************************************/
void LED_PWM_Clock_ClearModeRegister(uint8 clkMode) 
{
    LED_PWM_Clock_MOD_SRC &= ~clkMode | ~LED_PWM_Clock_MODE_MASK;
}
...
{
    return LED_PWM_Clock_MOD_SRC & LED_PWM_Clock_MODE_MASK;
}
...
void LED_PWM_Clock_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        LED_PWM_Clock_MOD_SRC =
            (LED_PWM_Clock_MOD_SRC & ~LED_PWM_Clock_SRC_SEL_MSK) | clkSource;
    }
