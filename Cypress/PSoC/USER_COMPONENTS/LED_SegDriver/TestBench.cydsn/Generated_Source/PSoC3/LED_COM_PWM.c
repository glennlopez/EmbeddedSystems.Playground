...
uint8 LED_COM_PWM_initVar = 0u;

/*******************************************************************************
* Function Name: LED_COM_PWM_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  LED_COM_PWM_initVar: Is modified when this function is called for the first 
...
void LED_COM_PWM_Start(void) 
{
    ...
    if(LED_COM_PWM_initVar == 0u)
    {
        LED_COM_PWM_Init();
        LED_COM_PWM_initVar = 1u;
    }
    LED_COM_PWM_Enable();
...
/*******************************************************************************
* Function Name: LED_COM_PWM_Init
********************************************************************************
*
* Summary:
...
{
    #if (LED_COM_PWM_UsingFixedFunction || LED_COM_PWM_UseControl)
        uint8 ctrl;
    #endif
            ...
            uint8 LED_COM_PWM_interruptState;
        #endif
    #endif
        ...
        ctrl = LED_COM_PWM_CONTROL & ~LED_COM_PWM_CTRL_CMPMODE2_MASK & ~LED_COM_PWM_CTRL_CMPMODE1_MASK;
        LED_COM_PWM_CONTROL = ctrl | LED_COM_PWM_DEFAULT_COMPARE2_MODE | LED_COM_PWM_DEFAULT_COMPARE1_MODE;
    #endif 
        
    #if (!LED_COM_PWM_UsingFixedFunction)
        #if (LED_COM_PWM_Resolution == 8)
            /* Set FIFO 0 to 1 byte register for period*/
            LED_COM_PWM_AUX_CONTROLDP0 |= (LED_COM_PWM_AUX_CTRL_FIFO0_CLR);
        #else /* (LED_COM_PWM_Resolution == 16)*/
            /* Set FIFO 0 to 1 byte register for period */
            LED_COM_PWM_AUX_CONTROLDP0 |= (LED_COM_PWM_AUX_CTRL_FIFO0_CLR);
    ...
    LED_COM_PWM_WritePeriod(LED_COM_PWM_INIT_PERIOD_VALUE);
    LED_COM_PWM_WriteCounter(LED_COM_PWM_INIT_PERIOD_VALUE);
        
        #if (LED_COM_PWM_UseOneCompareMode)
            LED_COM_PWM_WriteCompare(LED_COM_PWM_INIT_COMPARE_VALUE1);
        #else
        ...
        LED_COM_PWM_SetInterruptMode(LED_COM_PWM_INIT_INTERRUPTS_MODE);
    #endif
        ...
        LED_COM_PWM_CONTROL2 |= LED_COM_PWM_CTRL2_IRQ_SEL;
            ...
            LED_COM_PWM_interruptState = CyEnterCriticalSection();
            /* Use the interrupt output of the status register for IRQ output */
            LED_COM_PWM_STATUS_AUX_CTRL |= LED_COM_PWM_STATUS_ACTL_INT_EN_MASK;
            
             /* Exit Critical Region*/
            CyExitCriticalSection(LED_COM_PWM_interruptState);
            
            /* Clear the FIFO to enable the LED_COM_PWM_STATUS_FIFOFULL
                   bit to be set on FIFO full. */
            LED_COM_PWM_ClearFIFO();
        #endif
    #endif
}
...
/*******************************************************************************
* Function Name: LED_COM_PWM_Enable
********************************************************************************
*
* Summary: 
...
void LED_COM_PWM_Enable(void) 
{
    ...
    #if (LED_COM_PWM_UseControl || LED_COM_PWM_UsingFixedFunction)
        LED_COM_PWM_CONTROL |= LED_COM_PWM_CTRL_ENABLE;
    #endif
}


/*******************************************************************************
* Function Name: LED_COM_PWM_Stop
********************************************************************************
*
* Summary:
...
void LED_COM_PWM_SetCompareMode(uint8 comparemode) 
{
    ...
    #elif (LED_COM_PWM_UseControl)
        uint8 comparemode1masked = (comparemode << LED_COM_PWM_CTRL_CMPMODE1_SHIFT) & LED_COM_PWM_CTRL_CMPMODE1_MASK;
        uint8 comparemode2masked = (comparemode << LED_COM_PWM_CTRL_CMPMODE2_SHIFT) & LED_COM_PWM_CTRL_CMPMODE2_MASK;
        LED_COM_PWM_CONTROL &= ~(LED_COM_PWM_CTRL_CMPMODE1_MASK | LED_COM_PWM_CTRL_CMPMODE2_MASK); /*Clear existing mode */
...
{
    uint8 comparemodemasked = (comparemode << LED_COM_PWM_CTRL_CMPMODE1_SHIFT) & LED_COM_PWM_CTRL_CMPMODE1_MASK;
    #if(LED_COM_PWM_UsingFixedFunction)
            #if(LED_COM_PWM_PSOC3_ES2 || LED_COM_PWM_PSOC5_ES1)
...
void LED_COM_PWM_SetCompareMode2(uint8 comparemode) 
{
    ...
    #elif (LED_COM_PWM_UseControl)
    uint8 comparemodemasked = (comparemode << LED_COM_PWM_CTRL_CMPMODE2_SHIFT) & LED_COM_PWM_CTRL_CMPMODE2_MASK;
...
/*******************************************************************************
* Function Name: LED_COM_PWM_WriteCounter
********************************************************************************
* 
* Summary:
...
void LED_COM_PWM_WriteCounter(uint8 counter) 
{
    ...
    #else
        CY_SET_REG8(LED_COM_PWM_COUNTER_LSB_PTR, counter);
    #endif
}
...
#if (!LED_COM_PWM_UsingFixedFunction)
/*******************************************************************************
* Function Name: LED_COM_PWM_ReadCounter
********************************************************************************
* 
* Summary:
...
uint8 LED_COM_PWM_ReadCounter(void) 
{
    ...
    CY_GET_REG8(LED_COM_PWM_COUNTERCAP_LSB_PTR);
    
    /* Read the data from the FIFO (or capture register for Fixed Function)*/
    return (CY_GET_REG8(LED_COM_PWM_CAPTURE_LSB_PTR));
}


#if (LED_COM_PWM_UseStatus)
/*******************************************************************************
* Function Name: LED_COM_PWM_ClearFIFO
********************************************************************************
* 
* Summary:
...
{
    while(LED_COM_PWM_ReadStatusRegister() & LED_COM_PWM_STATUS_FIFONEMPTY)
        LED_COM_PWM_ReadCapture();
}
#endif /* LED_COM_PWM_UseStatus */
#endif /* !LED_COM_PWM_UsingFixedFunction */


/*******************************************************************************
* Function Name: LED_COM_PWM_WritePeriod
********************************************************************************
* 
* Summary:
...
void LED_COM_PWM_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(LED_COM_PWM_PERIOD_LSB_PTR, period);
    #endif
}
...
#if (LED_COM_PWM_UseOneCompareMode)
/*******************************************************************************
* Function Name: LED_COM_PWM_WriteCompare
********************************************************************************
* 
* Summary:
...
void LED_COM_PWM_WriteCompare(uint8 compare) 
{
   ...
   #if (LED_COM_PWM_PWMMode == LED_COM_PWM__B_PWM__DITHER)
...
void LED_COM_PWM_WriteDeadTime(uint8 deadtime) 
{
    /* If using the Dead Band 1-255 mode then just write the register */
        ...
        LED_COM_PWM_DEADBAND_COUNT &= ~LED_COM_PWM_DEADBAND_COUNT_MASK; 
            /* Set new dead time */
        LED_COM_PWM_DEADBAND_COUNT |= (deadtime << LED_COM_PWM_DEADBAND_COUNT_SHIFT) & LED_COM_PWM_DEADBAND_COUNT_MASK; 
    #endif
}
...
uint8 LED_COM_PWM_ReadDeadTime(void) 
{
    ...
    #else
        /* Otherwise the data has to be masked and offset */
        return ((LED_COM_PWM_DEADBAND_COUNT & LED_COM_PWM_DEADBAND_COUNT_MASK) >> LED_COM_PWM_DEADBAND_COUNT_SHIFT);
    #endif
}
#endif /* DeadBandUsed */
