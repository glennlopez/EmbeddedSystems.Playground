...
export LoadConfig_cy8c28445_led_blinky
export _LoadConfig_cy8c28445_led_blinky
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_cy8c28445_led_blinky
	lcall	LoadConfigTBL_cy8c28445_led_blinky_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration cy8c28445_led_blinky
;
;    Load configuration registers for cy8c28445_led_blinky.
...
;               CUR_PP
;
_LoadConfig_cy8c28445_led_blinky:
 LoadConfig_cy8c28445_led_blinky:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_cy8c28445_led_blinky_Bank0
    mov     X, <LoadConfigTBL_cy8c28445_led_blinky_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_cy8c28445_led_blinky_Bank1
    mov     X, <LoadConfigTBL_cy8c28445_led_blinky_Bank1
