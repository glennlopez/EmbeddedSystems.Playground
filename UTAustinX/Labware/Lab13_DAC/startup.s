...
__Vectors
        ...
        DCD     uDMA_Handler                ; uDMA Software Transfer 46
        DCD     uDMA_Error                  ; uDMA Error
        DCD     ADC1Seq0_Handler            ; ADC1 Sequence 0, NVIC_PRI12_R
        DCD     ADC1Seq1_Handler            ; ADC1 Sequence 1
        DCD     ADC1Seq2_Handler            ; ADC1 Sequence 2, 50
        DCD     ADC1Seq3_Handler            ; ADC1 Sequence 3
        DCD     I2S0_Handler                ; I2S0,            NVIC_PRI13_R
        DCD     ExtBus_Handler              ; External Bus Interface 0
        DCD     GPIOPortJ_Handler           ; GPIO Port J
        DCD     GPIOPortK_Handler           ; GPIO Port K
        DCD     GPIOPortL_Handler           ; GPIO Port L,     NVIC_PRI14_R
        DCD     SSI2_Handler                ; SSI2 Rx and Tx
        DCD     SSI3_Handler                ; SSI3 Rx and Tx
        DCD     UART3_Handler               ; UART3 Rx and Tx
        DCD     UART4_Handler               ; UART4 Rx and Tx, 60, NVIC_PRI15_R
        DCD     UART5_Handler               ; UART5 Rx and Tx
        DCD     UART6_Handler               ; UART6 Rx and Tx
        DCD     UART7_Handler               ; UART7 Rx and Tx
        DCD     0                           ; Reserved, NVIC_PRI16_R
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved
        DCD     I2C2_Handler                ; I2C2 Master and Slave, NVIC_PRI17_R
        DCD     I2C3_Handler                ; I2C3 Master and Slave
        DCD     Timer4A_Handler             ; Timer 4 subtimer A, interrupt 70, bits23-21
        DCD     Timer4B_Handler             ; Timer 4 subtimer B
        DCD     0                           ; Reserved 72, NVIC_PRI18_R
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved 74
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved 76, NVIC_PRI19_R
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved 78
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved 80, NVIC_PRI20_R
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved 82
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved 84, NVIC_PRI21_R
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved 86
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved 88, NVIC_PRI22_R
        DCD     0                           ; Reserved
        DCD     0                           ; Reserved 90
        DCD     0                           ; Reserved
        DCD     Timer5A_Handler             ; Timer 5 subtimer A interrupt number 92
